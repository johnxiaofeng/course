...
class PlotHelper:
    """
    a helper class for plotting images
    """
    ...
    @staticmethod
    def three_color_images(left_image, left_title, middle_image, middle_title, right_image, right_title):
        """
        plot three color images left, middle, right
        """
    ...
    def three_gray_images(left_image, left_title, middle_image, middle_title, right_image, right_title):
        """
        plot three gray images left, middle, right
        """
        fig, (ax1, ax2, ax3) = plt.subplots(1, 3, figsize=(24, 9))
        fig.tight_layout()
